...
//Finding the longest word
	...
	JOptionPane.showMessageDialog(null, "The longest substring in the given text is '" + longest + "' and it has " + longest.length() + " characters");
}

//This method will return a positive or negative if it finds char b in string a
